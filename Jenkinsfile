      ...
      stage('collect artifact'){
         ...
         stage('upload to ec2')
          ...
          sshagent(['513fbce6-0f7a-4bc0-8cd9-66f09ab7ab56']){
                   ...
                   sh 'scp -r C:/Windows/System32/config/systemprofile/AppData/Local/Jenkins/.jenkins/workspace/new-pipeline/target/*.jar ubuntu@52.25.51.185:/home/ubuntu/artifacts'
                     }
              }
           }
         stage('upload to s3')
